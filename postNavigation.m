...
%% Coordinate conversion ==================================================
    ...
    % === Calculate 3D errors =============================================
    % Added by Sergio Vicenzo - Added on 16 July 2024
...
% Added by Sergio Vicenzo - 26 Aug 2024
...
if settings.MMT == 1
     title([settings.outfile_root, ' Geoplot (with MMT)'],...
         'Interpreter','none')
    legend('MMT-integrated Least Squares (Scalar Tracking)',...
        'MMT-integrated DPE','GT');

    saveas(gcf, [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_geoplot (with MMT).png']);
    saveas(gcf, [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_geoplot (with MMT)']);
else
...
if settings.MMT == 1
    legend('MMT-integrated Least Squares (Scalar Tracking)',...
        'MMT-integrated DPE','FontSize',12);
else
...
if settings.MMT == 1
    title([settings.outfile_root,' 2D Positioning Error (with MMT)'],...
    'Interpreter','none');
    saveas(gcf, ...
        [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_2DPositioning Error (with MMT)']);
    saveas(gcf, ...
        [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_2DPositioning Error (with MMT).png']);
...
if settings.MMT == 1
    legend('MMT-integrated Least Squares (Scalar Tracking)',...
        'MMT-integrated DPE','FontSize',12);
    title([settings.outfile_root,' 3D Positioning Error (with MMT)'],...
    'Interpreter','none');
    saveas(gcf, ...
        [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_3DPositioning Error (with MMT)']);
    saveas(gcf, ...
        [pwd ,'\',settings.outfile_root,'\',...
        settings.outfile_root,'_3DPositioning Error (with MMT).png']);
else
    legend('Least Squares (Scalar Tracking)','DPE','FontSize',12);
