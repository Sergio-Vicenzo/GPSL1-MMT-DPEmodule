...
trackResults.MMT_carrPhase_LOS              = nan(1, settings.msToProcess);
trackResults.MMT_carrPhase_NLOS             = nan(1, settings.msToProcess);
trackResults.MMT_amp_LOS                    = nan(1, settings.msToProcess);
trackResults.MMT_amp_NLOS                   = nan(1, settings.msToProcess);
        ...
        for loopCnt =  1:codePeriods
            ...
            parfor delay1_index=1:LOS_length
                ...
                for delay2_index=1:NLOS_length
                    ...
                    % Assume that the maximum reflected path is 0.5 chips
                    if delay2 >= delay1 && delay2-delay1 <= 0.5
                        ...
                        if ~isreal(gamma_12)==1
                            ...
                            a3 = ((R_mm_0 * R_xm_1) - (R_xm_2*R_mm_12))/...
                                (R_mm_0^2 - R_mm_12^2);
            
                            b3 = ((R_mm_0 * R_xm_2) - (R_xm_1*R_mm_12))/...
                                 (R_mm_0^2 - R_mm_12^2);
            
                            c3 = ((R_mm_0 * R_ym_1) - (R_ym_2*R_mm_12))/...
                                (R_mm_0^2 - R_mm_12^2);
                            
                            d3 = ((R_mm_0 * R_ym_2) - (R_ym_1*R_mm_12))/...
                                 (R_mm_0^2 - R_mm_12^2);
            ...
            NLOS_delay = mean(codeDelay_NLOS(codeDelay_NLOS_indx));
            ...
            LOS_amp=(sqrt((store_a(codeDelay_LOS_indx,codeDelay_NLOS_indx)).^2 + ...
                    (store_c(codeDelay_LOS_indx,codeDelay_NLOS_indx)).^2));
            ...
            NLOS_amp=(sqrt((store_b(codeDelay_LOS_indx,codeDelay_NLOS_indx)).^2 + ...
                    (store_d(codeDelay_LOS_indx,codeDelay_NLOS_indx)).^2));
...
%                 (sqrt(I_E * I_E + Q_E * Q_E) + sqrt(I_L * I_L + Q_L * Q_L));
        ...
        % In case anything fails... (Sergio Vicenzo - 26 Dec 2024)
         save([settings.outfile_root, '\trackResults_gps_MMT_', ...
                settings.outfile_root], 'trackResults', 'settings', ...
                'channel'); 
